...
def CBIR_tekstur(image1, image2):
    ...
    # sudut 90
    glcm_matrix1_sudut90 = matrixGLCM(image1, d=1)
    ...
    vector1 = createVector(contrast1_sudut90, homogeneity1_sudut90, entropy1_sudut90, dissimilarity1_sudut90, energy1_sudut90, correlation1_sudut90)

    ## BUAT VECTOR BERISI CONTRAST, HOMOGENEITY, DAN ENTROPY DARI IMAGE 2
    # sudut 90
    glcm_matrix2_sudut90 = matrixGLCM(image2, d=1)
    ...
    vector2 = createVector(contrast2_sudut90, homogeneity2_sudut90, entropy2_sudut90, dissimilarity2_sudut90, energy2_sudut90, correlation2_sudut90)
...
if __name__ == '__main__':
    ...
    reference_image = cv2.imread('img/contoh2/meng.jpg')
